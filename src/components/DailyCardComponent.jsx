...
export const DailyCardComponent = () => {
	return (
		<div className='flex justify-center pt-4 mb-12 h-cover'>
			<section id='infoButton' className='w-10/12 overflow-hidden rounded-lg shadow-md bg-white/50 backdrop-blur-md shadow-white/40'>
				...
				<section id='weatherIcon' className='flex justify-center -mt-14'>
					<img src={WeatherIcon} className='object-cover w-auto h-cover' alt='weather' />
				</section>
